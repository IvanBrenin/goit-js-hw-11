...
var _axiosPhotos = require("./axiosPhotos");
...
(0, _preloader.preloaderStart)();
(0, _preloader.preloaderStop)();
function onFormSubmit(e) {
    e.preventDefault();
    (0, _preloader.preloaderStart)();
    (0, _axiosPhotos.objectPage).searchValue = e.currentTarget.elements.searchQuery.value.trim();
    (0, _axiosPhotos.resetPage)();
    (0, _axiosPhotos.getData)((0, _axiosPhotos.objectPage).searchValue).then(({ hits , totalHits  })=>{
        onClear();
        window.scrollTo(document.body, 0, 600);
        if (totalHits === 0 || (0, _axiosPhotos.objectPage).searchValue === "") {
            axiosError();
            (0, _preloader.preloaderStop)();
        } else {
    ...
    entries.forEach((entry)=>{
        ...
        if (entry.isIntersecting) {
            ...
            (0, _axiosPhotos.getData)((0, _axiosPhotos.objectPage).searchValue).then(({ hits , totalHits  })=>{
                ...
                (0, _preloader.preloaderStop)();
                const pages = Math.ceil(totalHits / (0, _axiosPhotos.objectPage).per_page);
                if ((0, _axiosPhotos.objectPage).page >= pages) {
...
},{"notiflix":"5z0Oc","./axiosPhotos":"6rmlz","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","./preloader":"gkVpk","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5z0Oc":[function(require,module,exports) {
var global = arguments[3];
...
},{}],"6rmlz":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "objectPage", ()=>objectPage);
parcelHelpers.export(exports, "getData", ()=>getData);
parcelHelpers.export(exports, "incrementPage", ()=>incrementPage);
parcelHelpers.export(exports, "resetPage", ()=>resetPage);
...
const getData = async (searchValue)=>{
    const response = await (0, _axiosDefault.default).get(`${BASE_URL}?key=33675530-14a54e49ac2d12a2b0a037dca&q=${searchValue}&image_type=photo&orientation=horizontal&safesearch=true&page=${objectPage.page}&per_page=${objectPage.per_page}`);
...
var Buffer = require("2ba51ca95d0ad27a").Buffer;
"use strict";
/**
...
},{"2ba51ca95d0ad27a":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("48d23d7130f5b5a");
var ieee754 = require("5546f2b002540854");
...
},{"48d23d7130f5b5a":"eIiSV","5546f2b002540854":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{}],"kaxSc":[function() {},{}],"gkVpk":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "preloaderStart", ()=>preloaderStart);
parcelHelpers.export(exports, "preloaderStop", ()=>preloaderStop);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["gHDMI","ebWYT"], "ebWYT", "parcelRequirea610")
